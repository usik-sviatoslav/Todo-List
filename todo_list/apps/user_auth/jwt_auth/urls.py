...
from .views import LoginAPIView, LogoutAPIView, SignupAPIView, VerifyEmailAPIView
...
VerifyEmailAPIView = extend_schema(tags=["Email Verification"])(VerifyEmailAPIView)
